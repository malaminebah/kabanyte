...
const LABELS = {
  ...
  REVIEW: { id: 'review', text: 'Review', color: 'bg-gray-400 dark:bg-orange-500' },
} as const;
...
export default function Board({ boardId }: { boardId: string }) {
  ...
  const [cards, setCards] = useState<Card[]>([
    { id: "1", title: "Tâche 1", description: "Description 1", columnId: "todo", boardId, labels: [] },
    { id: "2", title: "Tâche 2", description: "Description 2", columnId: "inProgress", boardId, labels: [] },
    { id: "3", title: "Tâche 3", description: "Description 3", columnId: "done", boardId, labels: [] },
    { id: "4", title: "Tâche 4", description: "Description 4", columnId: "review", boardId, labels: [] },
  ]);
  ...
  const handleSaveCardModal = (cardId: string, updates: { description: string; labels: LabelType[] }) => {
